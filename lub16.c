...
int prov_1(void) /* Фнкция проверки ввода данных с клавиатуры */
{
    int i2 = 0, e_line = 0;
    char c;
    while (1)
...
int prov_5(void) /* Зполнение массива */
{
    ...
    while(1)
    {
        ...
        if (c_w_err == 0)
        {
            if (((i2 == 9) && (m_elem[0] == '-') && (m_elem[1] > 2)) || ((i2 == 8) && (((m_elem[0] - '0') > 2))) || (i2 > 9))
            {
...
{
    int c_w_err = 0, m, i2 = 0, m_num = e_m_num;
    char c, *mx_el;
    while (1)
    {
...
{
    int m_num = e_m_num, i2, n, c_w_err;
    char c, *mn_el;
    while (1)
    {
